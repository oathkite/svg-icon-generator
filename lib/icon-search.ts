...
export const iconMetadata: Record<
	string,
	{ keywords: string[]; collection: string; name: string }[]
> = {
	mail: [
		{
			keywords: ["mail", "email", "envelope", "message", "メール"],
	...
	user: [
		{
			keywords: ["user", "person", "account", "ユーザー"],
			collection: "material-symbols",
			name: "person",
		},
	...
	search: [
		{
			keywords: ["search", "find", "magnifying", "検索"],
			collection: "material-symbols",
			name: "search",
		},
		{
	...
	check: [
		{
			keywords: ["check", "done", "checkmark", "チェック"],
			collection: "material-symbols",
			name: "check",
		},
	...
	heart: [
		{
			keywords: ["heart", "love", "favorite", "ハート"],
			collection: "material-symbols",
			name: "favorite",
		},
	...
	download: [
		{
			keywords: ["download", "save", "ダウンロード"],
			collection: "material-symbols",
			name: "download",
		},
		{
			keywords: ["download", "arrow-down"],
			collection: "heroicons",
	...
	upload: [
		{
			keywords: ["upload", "import", "アップロード"],
			collection: "material-symbols",
			name: "upload",
		},
		{
			keywords: ["upload", "arrow-up"],
			collection: "heroicons",
			name: "arrow-up-tray",
		},
	...
	delete: [
		{
			keywords: ["delete", "trash", "remove", "削除", "ゴミ箱"],
			collection: "material-symbols",
			name: "delete",
		},
	...
	lock: [
		{
			keywords: ["lock", "security", "password", "ロック"],
			collection: "material-symbols",
			name: "lock",
		},
	...
	unlock: [
		{
			keywords: ["unlock", "open", "アンロック"],
			collection: "material-symbols",
			name: "lock-open",
		},
		{
			keywords: ["unlock", "lock-open"],
			collection: "heroicons",
			name: "lock-open",
		},
	...
	calendar: [
		{
			keywords: ["calendar", "date", "schedule", "カレンダー"],
			collection: "material-symbols",
			name: "calendar-today",
		},
